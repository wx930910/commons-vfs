...
abstract class AbstractSftpProviderTestCase extends AbstractProviderTestConfig {
	...
	/**
	 * Implements FileSystemFactory because SSHd does not know about users and home
	 * directories.
	 */
	...
	/**
	 * Implements FileSystemView because SSHd does not know about users and home
	 * directories.
	 */
	...
	/**
	 * Extends NativeSshFile because its constructor is protected and I do not want
	 * to create a whole NativeSshFile implementation for testing.
	 */
	...
	public FileObject getBaseTestFolder(final FileSystemManager manager) throws Exception {
		...
		builder.setIdentityRepositoryFactory(fileSystemOptions,
				TestIdentityRepositoryFactory.mockIdentityRepositoryFactory1());
	 ...
	 * @param callback An object whose method {@linkplain ExitCallback#onExit(int)}
	 *                 will be called when the pipe is broken. The integer argument
	 *                 is 0 if everything went well.
	 */

...
public class DefaultFileMonitorTest {
	...
	public FileListener mockFileListener1() throws Exception, Exception, Exception {
	...
	@Test
	public void testFileCreated() throws Exception, Exception, Exception, Exception {
	...
	@Test
	public void testFileDeleted() throws Exception, Exception, Exception, Exception {
		writeToFile(testFile);
	...
	@Test
	public void testFileModified() throws Exception, Exception, Exception, Exception {
		writeToFile(testFile);
		try (final FileObject fileObject = fsManager.resolveFile(testFile.toURI().toURL().toString())) {
			final DefaultFileMonitor monitor = new DefaultFileMonitor(mockFileListener1());
			// TestFileListener manipulates changeStatus
	...
	@Test
	public void testFileRecreated() throws Exception, Exception, Exception, Exception {
		try (final FileObject fileObject = fsManager.resolveFile(testFile.toURI().toURL().toString())) {
			final DefaultFileMonitor monitor = new DefaultFileMonitor(mockFileListener1());
			// TestFileListener manipulates changeStatus
			monitor.setDelay(DELAY_MILLIS);
	...
	@Test
	public void testChildFileRecreated() throws Exception, Exception, Exception, Exception {
		writeToFile(testFile);
	...
	@Test
	public void testChildFileDeletedWithoutRecursiveChecking() throws Exception, Exception, Exception, Exception {
		writeToFile(testFile);
	...
	@Test
	public void testFileMonitorRestarted() throws Exception, Exception, Exception, Exception {
		try (final FileObject fileObject = fsManager.resolveFile(testFile.toURI().toString())) {
			final DefaultFileMonitor monitor = new DefaultFileMonitor(mockFileListener1());
			// TestFileListener manipulates changeStatus
			monitor.setDelay(DELAY_MILLIS);
	...
	@Ignore("VFS-299")
	@Test
	public void ignore_testAddRemove() throws Exception, Exception, Exception, Exception {
		try (final FileObject fileObject = fsManager.resolveFile(testFile.toURI().toString())) {
	...
	@Ignore("VFS-299")
	@Test
	public void ignore_testStartStop()

...
public class ProviderDeleteTests extends AbstractProviderTestCase {
	...
	public FileSelector mockFileSelector1(final String basename) throws Exception, Exception {
	 ...
	 */
	@Test
	public void testDeleteOneFiles() throws Exception, Exception, Exception {
		final FileObject scratchFolder = createScratchFolder();
